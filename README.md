...
The codes are still under cleanup and development, and should not be used in any security-sensitive product. Further content and details will be added progressively.
...
The layer_importance.py and layer_importance_v3.py are developed based on [OTO](https://github.com/tianyic/only_train_once_personal_footprint).
